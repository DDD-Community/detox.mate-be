...
class GroupChallengeControllerTest {
    ...
    private FieldDescriptor[] groupChallengeResponseFields() {
        return new FieldDescriptor[] {
                ...
                fieldWithPath("participants[].profileImageUrl").type(JsonFieldType.STRING).description("저장된 프로필 이미지 object key를 읽기 URL로 변환한 값").optional(),
                ...
                fieldWithPath("participants[].isUserWithdrawn").type(JsonFieldType.BOOLEAN).description("회원 탈퇴한 사용자인지 여부"),
