...
class NotificationTypeRepositoryTest {
    ...
    void findByCode(){
        ...
        //when
        Optional<NotificationType> found = notificationTypeRepository.findByTypeCode(NotificationTypeCode.COMMENT);
    ...
    void findByCodeNotExists(){
        ...
        //when
        Optional<NotificationType> found= notificationTypeRepository.findByTypeCode(NotificationTypeCode.REACTION);
